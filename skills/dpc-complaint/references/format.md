...
7. **V. PROPOSED RESOLUTION** — a one-line lead-in ("The Parent proposes the following resolution:"), then each remedy as its own lettered sub-paragraph — (a), (b), (c) … — indented under it, in the person's own words, each ending with a semicolon and the last with a period. A single remedy is one sentence.
