...
- The proposed resolution: each remedy names its own figures — the 24 sessions the log records as owed, the 150 minutes a week the IEP requires — and the document that gives them. Never send the reader to a paragraph number for a remedy.
